            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.dashboard')">
                        ...
                        <x-jet-nav-link href="{{ route('admin.dealer') }}" :active="request()->routeIs('admin.dealer')">
                            {{ __('Dealers') }}
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('admin.catalog') }}" :active="request()->routeIs('admin.catalog')">
                            {{ __('Catalog') }}
                        </x-jet-nav-link>
                    ...
                    @if(Auth::user()->role == 'dealer')
                        ...
                        <x-jet-nav-link href="{{ route('dealer.catalog') }}" :active="request()->routeIs('dealer.catalog')">
                            {{ __('Catalog') }}
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('dealer.invoice') }}" :active="request()->routeIs('dealer.invoice')">
                            {{ __('Invoice') }}
                        </x-jet-nav-link>
                    
                        <x-jet-nav-link href="{{ route('dealer.price_lists')}}" :active="request()->routeIs('dealer.price_lists')">
                            {{__('Price List')}}
                        </x-jet-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->role == 'admin')
                ...
                <x-jet-responsive-nav-link href="{{ route('admin.dealer') }}" :active="request()->routeIs('admin.dealer')">
                    {{ __('Dealer') }}
                </x-jet-responsive-nav-link>
                <x-jet-responsive-nav-link href="{{ route('admin.catalog') }}" :active="request()->routeIs('admin.catalog')">
                    {{ __('Catalog') }}
                </x-jet-responsive-nav-link>
